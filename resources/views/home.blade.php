        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="{{(request()->route()->getName()=='home#property')?'active':''}}" class="navbar-link" data-nav-link>Property</a>
              </li>
      ...
      <section class="about" id="about">
        <div class="container">
          ...
          <figure class="about-banner">
            ...
            <img src="{{ asset('images/about-banner-2.png') }}" alt="House interior" class="abs-img">
          </figure>
          ...
          <li>
            <div class="property-card">
                <div class="card-content">
                    ...
                    <a href="{{ route('hostels.show', ['id' => $hostels->H_id]) }}" class="btn btn-primary">View Details</a>                    </div>
            </div>
          </li>
          @endforeach
          ...
          <ul class="features-list">
            ...
            <li>
              <a href="#" class="features-card">
                ...
                <h3 class="card-title">unlimited water supply</h3>
            ...
            <li>
              <a href="#" class="features-card">
                ...
                <h3 class="card-title">Study Area</h3>
            ...
            <li>
              <a href="#" class="features-card">
                ...
                <h3 class="card-title">Comfortable Beds</h3>
